...
A definição das atividades, passos, ou procedimentos que compõem o método pode (ou mesmo deve) estar baseado em autores. Esses autores, normalmente, estão relacionados à engenharia de software.
